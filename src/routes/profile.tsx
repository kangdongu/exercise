            ...
            {Boolean(userImg) ? (
              <>
                <div style={{ position: 'absolute', width: '25px', height: '25px', backgroundColor: 'white', borderRadius: '50%', bottom: '0px', right: '0', border: '1px solid lightgray' }}>
                  <FaExchangeAlt style={{ width: '15px', height: '15px', marginLeft: '5px', marginTop: '5px', fill: '#FF286F' }} />
                </div>
              ...
              <>
                <div style={{ position: 'absolute', width: '25px', height: '25px', backgroundColor: 'white', borderRadius: '50%', bottom: '0px', right: '0', border: '1px solid lightgray' }}>
                  <TiPlus style={{ width: '20px', height: '20px', marginLeft: '2.5px', marginTop: '2.5px', fill: '#FF286F' }} />
                </div>
